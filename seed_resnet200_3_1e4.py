...
save_path = f'../output/models/seed_resnet200_3_1e4_best_model.pt'
img_size = 300
T_max = 10
eta_min = 1e-6
...
for epoch in range(EPOCHS):
    ...
    # plt.show()
    plt.grid(True)
    plt.savefig('../output/seed_resnet200_3_1e4.png')
...
submission.to_csv('../output/seed_resnet200_3_1e4_tta.csv', index=False)
print("create csv")
